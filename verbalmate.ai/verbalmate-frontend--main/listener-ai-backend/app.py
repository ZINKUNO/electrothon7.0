...
with st.sidebar:
    ...
    <div style="text-align: center; margin-bottom: 20px;">
        <h1 style="color: var(--primary-color); font-size: 24px; margin-bottom: 10px;">
            <span style="font-size: 32px;">🎤</span> VerbalMate AI
        </h1>
    ...
    st.markdown("## About")
    st.markdown("""
    VerbalMate AI helps you analyze your conversations and improve your communication skills using advanced AI technology.
    ...
    **How to use:**
    ...
    <div style="text-align: center; margin-top: 30px; color: #6c757d; font-size: 12px;">
        <p>VerbalMate AI v1.0.0</p>
        <p>© 2024 VerbalMate AI</p>
    </div>
    """, unsafe_allow_html=True)

# Main content
st.markdown('<div class="main-header">🎤 VerbalMate AI</div>', unsafe_allow_html=True)
...
with main_container:
    ...
    if not use_sample:
        ...
        st.markdown("Upload an audio file of your conversation to analyze your communication skills.")
    ...
    if use_sample:
        ...
        <div style="text-align: center; padding: 20px;">
            <h3 style="color: var(--primary-color);">Welcome to VerbalMate AI! 👋</h3>
...
# Footer
st.markdown('<div class="footer">© 2025 VerbalMate AI. All rights reserved.</div>', unsafe_allow_html=True)